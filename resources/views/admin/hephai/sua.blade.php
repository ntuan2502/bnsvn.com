                ...
                <div class="ibox-content">
                    <form action="" method="POST" class="form form--basic">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="name" name="name" value="{{$hephai->name}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="abstract">Mô tả</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" name="abstract" id="abstract" rows="5">{{$hephai->abstract}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="element">Hệ</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="element" name="element" value="{{$hephai->element}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="icon_url">Icon URL</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="icon_url" name="icon_url" value="{{$hephai->icon_url}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Hình ảnh</label>
                            <div class="col-sm-10">
                                <img style="width: 9rem;" id="preview" src="{{$hephai->icon_url}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-12">
