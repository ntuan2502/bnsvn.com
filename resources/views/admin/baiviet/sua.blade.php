                ...
                <div class="ibox-content">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="url" name="url" value="{{$post->url}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="abstract">Tóm tắt</label>
                            <div class="col-sm-10">
                                <textarea name="abstract" id="abstract" class="form-control" rows="5">{{$post->abstract}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control tagsinput" type="text" id="keywords" name="keywords" value="{{$post->keywords}}">
                            </div>
                        </div>
                        <div class="form-group row">
